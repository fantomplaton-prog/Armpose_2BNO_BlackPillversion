...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : BNO_CS1_Pin BNO_CS2_Pin */
  ...
  /*Configure GPIO pins : BNO_INT1_Pin BNO_INT2_Pin */
  GPIO_InitStruct.Pin = BNO_INT1_Pin|BNO_INT2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : BNO_RST1_Pin BNO_WAKE1_Pin BNO_RST2_Pin BNO_WAKE2_Pin */
